...
exports.book_delete_post = asyncHandler(async (req, res, next) => {
  ...
  if(bookInstances > 0)
  {
    //books have book instances , render as the same way as the get route
    res.render("book_delete" , {
      title : "Delete Book",
      book : book,
      BookInstances : bookInstances,
  ...
  {
    //it has no book instances , so when deleted on button redirect him to the book/details page
